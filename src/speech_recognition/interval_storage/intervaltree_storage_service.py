...
from .interfaces import IntervalStorageService
...
class IntervalTreeStorageService(IntervalStorageService):
    ...
    def get(self, timestamp_from: float, timestamp_to: float) -> tuple[str, ...]:
        ...
        **[timestamp_from, timestamp_to)**.
        ...
        return tuple(iv.data for iv in sorted(results))  # pyright: ignore[reportUnknownMemberType, reportUnknownVariableType, reportUnknownArgumentType]
